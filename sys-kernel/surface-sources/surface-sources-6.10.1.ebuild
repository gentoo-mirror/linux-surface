...
src_prepare() {
	eapply "${FILESDIR}/6.10/0001-secureboot.patch"
	eapply "${FILESDIR}/6.10/0002-surface3-oemb.patch"
	eapply "${FILESDIR}/6.10/0003-mwifiex.patch"
	...
	eapply "${FILESDIR}/6.10/0011-surface-shutdown.patch"
	eapply "${FILESDIR}/6.10/0012-surface-gpe.patch"
	eapply "${FILESDIR}/6.10/0013-cameras.patch"
	eapply "${FILESDIR}/6.10/0014-amd-gpio.patch"
	eapply "${FILESDIR}/6.10/0015-rtc.patch"
	eapply_user
}
